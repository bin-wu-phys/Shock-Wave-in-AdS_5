...
b4t1nm2=b4t1;b4t2nm2=b4t2;a4nm2=a4;a1t1nm2=a1t1;a1t2nm2=a1t2;

%metric at tau - 2*dtau
[B S] = initializemetric(a1,tau,r,dr,mu,cbar);
theta = gettheta(dri, S, tau, a1, a1t1, a1t2, a4,b4, b4t1, b4t2, L, N);
phi = getphi(dr,dri, B, S, theta, tau, a1, a1t1, a1t2, a4, b4, b4t1, b4t2, L, N);
%Solve A
...
b4t1nm1=b4t1;b4t2nm1=b4t2;a4nm1=a4;a1t1nm1=a1t1;a1t2nm1=a1t2;

%metric at tau - 2*dtau
[B S] = initializemetric(a1,tau,r,dr,mu,cbar);Bnm1=B(1);
theta = gettheta(dri, S, tau, a1, a1t1, a1t2, a4,b4, b4t1, b4t2, L, N);
phi = getphi(dr, dri, B, S, theta, tau, a1, a1t1, a1t2, a4, b4, b4t1, b4t2, L, N);
%Solve A
A = getA( dr,dri,B, S, theta, phi, tau, a1, a1t1, a1t2, a4,b4,b4t1,b4t2, r );
...
[a1 a1nm1 a1nm2 a1t1 a1t2] = initializea1( tau, dtau,mu,cbar );
% a1t1 = 2*(a1 - a1nm1)/dtau-a1t1nm1;
% a1t2 = 2*(a1t1 - a1t1nm1)/dtau-a1t2nm1;
[b4 b4t1 b4t2 b4nm1 b4nm2] = initializeb4(a1, a1nm1, a1nm2, tau,dtau,mu);
% b4t1 = 2*(b4 - b4nm1)/dtau-b4t1nm1;
% b4t2 = 2*(b4t1 - b4t1nm1)/dtau-b4t2nm1;
a4 = initializea4(tau,mu);
...
while( tau <= tmax)
    ...
    a4nm2 = a4nm1;a4nm1=a4; 
    a4 = finda4(a1,a1nm1,a1nm2, a4,a4nm1,a4nm2,b4,b4nm1,b4nm2,tau,dtau ); tau = tau + dtau;
    
    %Find b4 at tau + dtau
    b4nm2 = b4nm1; b4nm1 = b4;
    b4t1nm2 = b4t1nm1; b4t1nm1 = b4t1;
    b4t2nm2 = b4t2nm1; b4t2nm1 = b4t2;
    a1nm2 = a1nm1; a1nm1 = a1;
    a1t1nm2 = a1t1nm1; a1t1nm1 = a1t1;
    a1t2nm2 = a1t2nm1; a1t2nm1 = a1t2;
    [a1 a1t1 a1t2] = finda1( a1nm1, a1nm2, a1t1nm1,a1t1nm2,a1t2nm1,a1t2nm2,a4,a4nm1,a4nm2, b4nm1,b4nm2,b4t1nm1,b4t1nm2,tau,dtau, B(1), Bnm1,Bnm2,L,dri,S,N);
    [b4 b4t1 b4t2] = findb4(a1, a1nm1, a1nm2, a1t1,a1t1nm1,a1t1nm2,a1t2,a1t2nm1,a1t2nm2,a4,a4nm1,a4nm2, b4nm1,b4nm2,b4t1nm1,b4t1nm2,tau,dtau, B(1), Bnm1,Bnm2,L);
    %
...
save(['latetimedatatau' num2str(floor(100*areaah(1,1))) 'to' num2str(floor(100*areaah(end,1))) 'L' num2str(L) 'Lmin' num2str(floor(100*Lmin)) 'N' num2str(N) 'mu' num2str(floor(100*mu)) 'c' num2str(floor(100*cbar))])
tElapse = toc