function a1 = finda1( dri,S,tau,dtau,a1nm1,a1nm2,a4,b4nm1,b4nm2,B,r,L,N)
%find a1 at tau + dtau
%   
a1 = fzero(@(x)getthetah(x,dri,S,tau,dtau,a1nm1,a1nm2,a4,b4nm1,b4nm2,B,r,L,N),a1nm1);


function thetah = getthetah(a1,dri, S, tau, dtau, a1nm1, a1nm2, a4, b4nm1, b4nm2,B,r, L, N)
% Get theta at r = 1
a1t1 = (a1 - a1nm1)/dtau;
