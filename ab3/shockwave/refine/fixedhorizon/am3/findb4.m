...
%   r:      r
%
fb4=b4nm1+dtau*(8*b4t1nm1-b4t1nm2)/12;
fb4p=b4t1nm1+dtau*(8*fb4t2(a1nm1,a1t1nm1,a1t2nm1,a4nm1,b4nm1,b4t1nm1,tau-dtau,Bnm1,r)-fb4t2(a1nm2,a1t1nm2,a1t2nm2,a4nm2,b4nm2,b4t1nm2,tau-2*dtau,Bnm2,r))/12;
%
b4=(16*(2268*fb4*tau^6+135*dtau*tau^5*(fb4+7*fb4p*tau+12*fb4*r*tau)+5*dtau^2*(232+3*r*tau*(-24+5*r^2*tau^2*(2+3*r*tau*(-1+r*tau*(2+3*B*r*tau))))))+5*dtau*tau*(45*dtau*tau^3*(35-6*r*tau)*a1^4+405*dtau*tau^4*a1^5+dtau*tau^2*a1^3*(4031-900*r*tau-1350*tau^2*(a1t1))+3*dtau*tau*a1^2*(8*(292-75*r*tau+15*r^3*tau^3)+15*tau^2*((-73+12*r*tau)*(a1t1)+7*tau*(a1t2)))+2*a1*(-6480*fb4*tau^5+dtau*(3742-360*r*tau*(3+r^2*tau^2*(-1+r*tau)))+45*dtau*tau^2*(8*tau^2*a4+(a1t1)*(-47+12*r*tau+7*tau^2*(a1t1))+7*tau*(a1t2)))+6*dtau*tau*(16*tau^2*(7-3*r*tau)*a4+5*(48*r^6*tau^4*log(tau)+(a1t1)*(-82+24*r*tau+21*tau^2*(a1t1))+14*tau*(a1t2)))))/(24*tau^4*(-160*dtau^2+90*dtau*tau+18*(84+5*dtau*r*(12+5*dtau*r))*tau^2+225*dtau*tau^2*a1*(-4*(3+dtau*r)+5*dtau*a1)));
b4t1=(16*(189*fb4p*tau^6+dtau*(232-72*r*tau+30*r^3*tau^3+3*(16*fb4-15*r^4)*tau^4+90*r^5*tau^5+135*r^2*(-fb4+B*r^4)*tau^6))+dtau*tau*(45*tau^3*(35-6*r*tau)*a1^4+405*tau^4*a1^5+tau^2*a1^3*(4031-900*r*tau-1350*tau^2*(a1t1))+3*tau*a1^2*(8*(292-75*r*tau+15*r^3*tau^3-225*fb4*tau^4)+15*tau^2*((-73+12*r*tau)*(a1t1)+7*tau*(a1t2)))+a1*(7484+720*r*tau*(-3+tau^2*(r^2-r^3*tau+6*fb4*tau^2))+90*tau^2*(8*tau^2*a4+(a1t1)*(-47+12*r*tau+7*tau^2*(a1t1))+7*tau*(a1t2)))+6*tau*(16*tau^2*(7-3*r*tau)*a4+5*(48*r^6*tau^4*log(tau)+(a1t1)*(-82+24*r*tau+21*tau^2*(a1t1))+14*tau*(a1t2)))))/(4*tau^4*(-80*dtau^2+45*dtau*tau+9*(84+5*dtau*r*(12+5*dtau*r))*tau^2)+450*dtau*tau^6*a1*(-4*(3+dtau*r)+5*dtau*a1));
