...
[a1 a1nm1 a1nm2 a1t1 a1t2] = initializea1( tau, dtau,mu,cbar );
a1t1 = 2.4*(a1 - a1nm1)/dtau-0.2*(8*a1t1nm1-a1t1nm2);
a1t2 = 2.4*(a1t1 - a1t1nm1)/dtau-0.2*(8*a1t2nm1-a1t2nm2);
[b4 b4t1 b4t2 b4nm1 b4nm2] = initializeb4(a1, a1nm1, a1nm2, tau,dtau,mu);
b4t1 = 2.4*(b4 - b4nm1)/dtau-0.2*(8*b4t1nm1-b4t1nm2);
b4t2 = 2.4*(b4t1 - b4t1nm1)/dtau-0.2*(8*b4t2nm1-b4t2nm2);
a4 = initializea4(tau,mu);
