 clf
 %
load latetimedatatau050to16L20Lmin10N128H30mu050;
sf = 1/omega;
...
%
load latetimedatatau100to1599L20Lmin11N128H30mu020cbar16.mat;
sf = 1/omega;
areaahold = areaah;
...
legend(['\tau_0 = ' num2str(0.5*0.04^(1/3))],['\tau_0 = ' num2str(0.5^(1/3))],['\tau_0 = 1.0'],'location','NorthEast')
