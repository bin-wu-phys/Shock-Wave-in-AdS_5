clear;
fn={'ansatz100to1599L20Lmin40N64mu10000c3200H30' ; 'ansatz100to1599L20Lmin40N128mu10000c3200H30' ; 'ansatz100to1599L20Lmin40N256mu10000c3200H30'};
lt={'^','V','-'};lc={'r','g','b'};
ntau=1501;
