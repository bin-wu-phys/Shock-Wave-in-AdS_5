...
%initial conditions
omega = 0;%adjust the position of the naive horizon, r_nh = omega/tau^(1/3)
tmax = 16;dtau = 1/N^2; 
tau = 0.9;
deltat = 0.1; nt = floor(deltat/dtau); dtau = deltat/nt;k = 0;
...
save(['latetimedatatau2to' num2str(tau) 'L' num2str(L) 'Lmin' num2str(floor(100*Lmin)) 'N' num2str(N) 'H' num2str(10*H) 'mu010'])
tElapse = toc